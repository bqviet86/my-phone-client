                        ...
                        <table className='w-full whitespace-no-wrap'>
                            <thead>
                                <tr className='text-xs font-semibold tracking-wide text-left text-gray-500 uppercase border-b dark:border-gray-700 bg-gray-50 dark:text-gray-400 dark:bg-gray-800'>
                                    ...
                                    <th className='px-4 py-6 text-xl text-center'>Tên thương hiệu</th>
                                    <th className='px-4 py-6 text-xl text-center'>Xóa</th>
                                </tr>
                            </thead>
                            <tbody className='bg-white divide-y dark:divide-gray-700 dark:bg-gray-800'>
                                {allBrand.map((brand) => (
                                    <tr key={brand._id} className='text-gray-700 dark:text-gray-400 '>
                                        ...
                                        <td className='px-4 py-7 text-center'>{brand.name}</td>
